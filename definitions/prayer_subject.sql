DROP TABLE IF EXISTS "prayer_subject" CASCADE;

CREATE TABLE IF NOT EXISTS "prayer_subject" (
...
COMMENT ON COLUMN "prayer_subject".prayer_subject_type IS 'Type of subject: individual, family, or group.';
...
/*** indexes ***/
CREATE INDEX IF NOT EXISTS idx_prayer_subject_created_by ON "prayer_subject" (created_by);
CREATE INDEX IF NOT EXISTS idx_prayer_subject_type ON "prayer_subject" (prayer_subject_type);
CREATE INDEX IF NOT EXISTS idx_prayer_subject_user_profile ON "prayer_subject" (user_profile_id);
CREATE INDEX IF NOT EXISTS idx_prayer_subject_display_sequence ON "prayer_subject" (created_by, display_sequence);
