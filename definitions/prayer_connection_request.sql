DROP TABLE IF EXISTS "prayer_connection_request" CASCADE;

CREATE TABLE IF NOT EXISTS "prayer_connection_request" (
...
/*** indexes ***/
CREATE INDEX IF NOT EXISTS idx_connection_request_target ON "prayer_connection_request" (target_user_id, status);
CREATE INDEX IF NOT EXISTS idx_connection_request_requester ON "prayer_connection_request" (requester_id);
CREATE INDEX IF NOT EXISTS idx_connection_request_subject ON "prayer_connection_request" (prayer_subject_id);
